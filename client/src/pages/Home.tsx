...
function formatDate(value: string | null) {
  ...
  // Support YYYY-MM-DD and ISO datetime formats
...
function Brand() {
  return (
    <span
      ...
      aria-label="IABAC International Association of Business Analytics Certification"
    >
      <img
        className="iabac-logo-image"
        src="/assets/iabac-logo.png"
        alt="IABAC International Association of Business Analytics Certification"
      />
    </span>
  );
}
    ...
    <>
      ...
      <header className="classic-main-nav">
        <div className="classic-nav-inner">
          <a href="/" className="classic-logo-link">
            <Brand />
          </a>
...
function Result({ certificate }: { certificate: Certificate }) {
  ...
  return (
    <div
      className={`classic-result ${isValid ? "is-valid" : "is-invalid"}`}
      aria-live="polite"
    >
      ...
      <div className="classic-result-grid">
        ...
        <div>
          <small>Numéro de passeport</small>
          <strong>{certificate.passport_number}</strong>
        </div>

        <div>
          <small>Date de naissance</small>
          <strong>{formatDate(certificate.date_of_birth)}</strong>
        </div>
        ...
        <div>
          <small>Date du certificat</small>
          <strong>{formatAcademicYear()}</strong>
        </div>
    ...
    <div className="classic-site">
      ...
      <main>
        <section className="classic-verify" id="verify">
          <h2>
            To check the validity of a certificate, please follow the
            instructions below:
          </h2>

          <div className="classic-steps">
            <div className="classic-step">
              <span className="classic-step-icon">
              ...
              <div>
                ...
                <small>
                  Type the Certificate Number as it appears on the certificate,
                  i.e IAB112000AA
                </small>
              </div>
            </div>
          ...
          <button
            className="classic-demo"
            onClick={() => void verify(sampleCode)}
          >
            Try sample certificate: <strong>{sampleCode}</strong>
          </button>
          ...
          {notFound && (
            <div className="classic-error" role="alert">
              ...
              <p>
                The Certificate Number entered can not be verified. Please
                ensure that you have entered the Certificate Number correctly
                and if the problem persists contact{" "}
                <a href="mailto:exams@iabac.org">exams@iabac.org</a>
              </p>
            </div>
          )}
        </section>
        ...
        <section className="classic-footer" id="about">
          <div className="classic-footer-inner">
            <div className="classic-footer-brand">
              <Brand />
              <p>Professional learning and certification, made clear.</p>
            </div>
            ...
            <div>
              ...
              <div className="classic-contact">
                ...
                <a href="mailto:exams@iabac.org">
                  Email: exams@iabac.org
                </a>

                <span>Phone no: +31 97 010280870</span>

                <span>
                  Address: IABAC™ Center,
                  <br />
                  Waterlinie 101, 5656 NB,
                  <br />
          ...
          <div className="classic-footer-bottom">
            <span>
              ©2016 - 2026 IABAC. All rights reserved | IABAC KVK-number
              (Commercial Registration Number): 73234893
            </span>

            <span>
              IABAC®, IABAC logo, DSF®, CDS®, CAIE®, CNLPE®, CCVE®, CDSHR®,
              CDSFIN®, CVAE®, CDLE® and other certification marks are
              registered trademarks of IABAC B.V., The Netherlands.
            </span>
          </div>
        </section>
      </main>
